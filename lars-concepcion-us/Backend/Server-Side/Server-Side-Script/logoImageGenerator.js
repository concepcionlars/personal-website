...
const path                                  = 'src/assets/default_image/logo.png';
const name                                  = 'default_logo';
                    ...
                    filesColl.listIndexes().toArray(function(error, indexes) {
                        ...
                        chunksColl.listIndexes().toArray(function(error, indexes) {
                            const defaultImage = {
                                ...
                                length: files.length,
                                schemaType: 'logo', //<<<<<<< for expiremental purposes
                                rotation: 0,
                                zoom: 0,
                                ...
                                if(err) {
                                    ...
                                    profileSchema.findOne({primary: true}, (err, foundSchema) => {
                                        if(err) {
                                            ...
                                            foundSchema.logo = newImageFile.id;
                                            foundSchema.save();
...
module.exports = logoImageGenerator;